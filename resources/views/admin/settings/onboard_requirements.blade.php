...
@section('header-title', 'Onboard Requirements')

@section('content')

@vite(['resources/css/admin/settings/onboard_requirements.css'])
...
<div class="page">
    ...
    <div class="page-header">
        ...
        <div>
            ...
            <h2>Onboard Requirement Management</h2>

            <p>Manage all onboard training requirements.</p>
...
@endif
            ...
            <td>
                ...
                <button
                    ...
                    data-frequency="{{ $requirement->frequency }}"
                    data-due="{{ $requirement->due_after_days }}"
...
<div id="addModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h2>Add Onboard Requirement</h2>

            <span class="close" onclick="closeModal()">&times;</span>
        </div>

       <form action="{{ route('admin.settings.onboard-requirements.store') }}" method="POST">
...
<div id="editModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h2>Edit Onboard Requirement</h2>
...
function openEditModal(button) {
    ...
    document.getElementById("edit_due").value = button.dataset.due;
    ...
    document.getElementById("editForm").action =
        "/admin/settings/onboard-requirements/" + button.dataset.id;
...
function openDeleteModal(id,title){
    ...
    "/admin/settings/onboard-requirements/"+id;
